...
FROM 'C:\Computer Files\Code College\SQL\My Queries\Analysis\Chap08\pls_fy2014_pupld14a.csv'
...
FROM 'C:\Computer Files\Code College\SQL\My Queries\Analysis\Chap08\pls_fy2009_pupld09a.csv'
WITH (FORMAT CSV, HEADER);
--------------------------------------------------------------------------------------------------
SELECT count(*)
