...
FROM 'C:\Computer Files\Code College\SQL\My Queries\Analysis\Chap09\MPI_Directory_by_Establishment_Name.csv'
...
COPY state_regions
FROM 'C:\Computer Files\Code College\SQL\My Queries\Analysis\Chap09\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
----------------------------------------------------------------------------------------------------
